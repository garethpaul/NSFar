...
- Hostile boundary regressions live in `scripts/test-check-baseline.py`; run `make test` for that focused suite.
...
- Do not rewrite the `gitfiti` numeric artifact without a reproducible source or documented provenance.
